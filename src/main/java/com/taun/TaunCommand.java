                ...
                ClientCommandManager.literal("pest")
                    ...
                    .then(ClientCommandManager.literal("extrasell")
                        ...
                        .then(ClientCommandManager.literal("vinyls")
                            ...
                            .then(ClientCommandManager.argument("threshold", IntegerArgumentType.integer(1, 20))
                                .executes(ctx -> { TaunCore.setVinylSellThreshold(IntegerArgumentType.getInteger(ctx, "threshold")); return 1; })))
                        .then(ClientCommandManager.literal("vinyl")
                            .then(ClientCommandManager.argument("threshold", IntegerArgumentType.integer(1, 20))
                                .executes(ctx -> { TaunCore.setVinylSellThreshold(IntegerArgumentType.getInteger(ctx, "threshold")); return 1; })))
                    )
